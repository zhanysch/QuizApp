...
class CustomResultDialog: AppCompatDialogFragment() {
    ...
    private lateinit var result : kg.appsstudio.daggerparttwo.data.model.pojo.Result
    ...
    private fun setDetails(result: kg.appsstudio.daggerparttwo.data.model.pojo.Result) {
    ...
    companion object {
        ...
        fun newInstance(result: kg.appsstudio.daggerparttwo.data.model.pojo.Result, onDialogListener: OnDialogListener): CustomResultDialog {
